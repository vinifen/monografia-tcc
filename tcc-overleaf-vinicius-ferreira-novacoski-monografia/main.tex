...
%% hyperref: pdfa tem de estar activo *antes* do pdfx carregar (senão o pdfx faz
%% \hypersetup{pdfa} tarde e estraga os links). Com pdfa, linktoc=all faz aparecer
%% "LinkbordercolorLinkcolor" nos títulos do sumário; linktoc=page deixa só o número
%% da página clicável (sem esse artefacto). Referências \ref e \autoref no texto seguem normais.
...
%% Monografia TCC~2 — ordem alinhada a trabalhos GP_COINT (ex.: Pablo 2025/2; Vinicius Domingues 2024/2)
\include{./capitulos/cap-trabalhos-relacionados}

\include{./capitulos/cap-referencial-teorico}

\include{./capitulos/cap-materiais-e-metodos}

\include{./capitulos/cap-desenvolvimento}

\include{./capitulos/cap-resultados}

%% Capítulos da fase de projeto (não incluir na monografia final)
%\include{./capitulos/cap-proposta}
%\include{./capitulos/cap-resultados-parciais}
