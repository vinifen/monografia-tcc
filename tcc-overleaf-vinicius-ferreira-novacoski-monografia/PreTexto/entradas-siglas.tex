...
\sigla{unicentro}{UNICENTRO}{Universidade Estadual do Centro-Oeste}
\sigla{mvc}{MVC}{\textit{Model, View, Controller}}
\sigla{php}{\textit{PHP}}{\textit{Hypertext Preprocessor}}
\sigla{ci/cd}{CI/CD}{\textit{Continuous Integration/Continuous Delivery}}
\sigla{moscow}{\textit{MoSCoW}}{\textit{Must-have}, \textit{Should-have}, \textit{Could-have} e \textit{Won’t-have}}
\sigla{ddd}{DDD}{\textit{Domain-Driven Design}}
